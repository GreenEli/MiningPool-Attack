package Cen_De.Compu_Cen_Decen1;
import Cen_De.Compu_Cen_Decen1.Common.*;
...
//import java.security.NoSuchAlgorithmException;
//import java.util.Random;
//MiningPools_Cen_Den<{0.1,0.05},0.05,0.05,0.05,{0.05,0.1}>
public class MiningPool_Cen_Decen_2 {
    public static void main(String [] args){
    	System.out.println("Type:MiningPools_Cen_Den<{0.1,0.05},0.05,0.05,0.05,{0.05,0.1}> Confirm_Number:5");
...
//        MutliThread m3=new MutliThread("Window 3");
        ...
        MutliThread_Cen_Den M5=new MutliThread_Cen_Den("USER_5","MiningPool_1");
        MutliThread_Cen_Den M6=new MutliThread_Cen_Den("USER_6","MiningPool_1");
        MutliThread_Cen_Den M7=new MutliThread_Cen_Den("USER_7","MiningPool_1");
        MutliThread_Cen_Den M8=new MutliThread_Cen_Den("USER_8","MiningPool_1");
        MutliThread_Cen_Den M9=new MutliThread_Cen_Den("USER_9","MiningPool_1");
        MutliThread_Cen_Den M10=new MutliThread_Cen_Den("USER_10","MiningPool_1");
        MutliThread_Cen_Den M11=new MutliThread_Cen_Den("USER_11","MiningPool_2");
        MutliThread_Cen_Den M12=new MutliThread_Cen_Den("USER_12","MiningPool_2");
        MutliThread_Cen_Den M13=new MutliThread_Cen_Den("USER_13","MiningPool_2");
        MutliThread_Cen_Den M14=new MutliThread_Cen_Den("USER_14","MiningPool_2");
        MutliThread_Cen_Den M15=new MutliThread_Cen_Den("USER_15","MiningPool_2");
        MutliThread_Cen_Den M16=new MutliThread_Cen_Den("USER_16","MiningPool_3");
        MutliThread_Cen_Den M17=new MutliThread_Cen_Den("USER_17","MiningPool_3");
        MutliThread_Cen_Den M18=new MutliThread_Cen_Den("USER_18","MiningPool_3");
        MutliThread_Cen_Den M19=new MutliThread_Cen_Den("USER_19","MiningPool_3");
        MutliThread_Cen_Den M20=new MutliThread_Cen_Den("USER_20","MiningPool_3");
        MutliThread_Cen_Den M21=new MutliThread_Cen_Den("USER_21","MiningPool_4");
        MutliThread_Cen_Den M22=new MutliThread_Cen_Den("USER_22","MiningPool_4");
        MutliThread_Cen_Den M23=new MutliThread_Cen_Den("USER_23","MiningPool_4");
        MutliThread_Cen_Den M24=new MutliThread_Cen_Den("USER_24","MiningPool_4");
        MutliThread_Cen_Den M25=new MutliThread_Cen_Den("USER_25","MiningPool_4");
        MutliThread_Cen_Den M26=new MutliThread_Cen_Den("USER_26","MiningPool_5");
        MutliThread_Cen_Den M27=new MutliThread_Cen_Den("USER_27","MiningPool_5");
        MutliThread_Cen_Den M28=new MutliThread_Cen_Den("USER_28","MiningPool_5");
        MutliThread_Cen_Den M29=new MutliThread_Cen_Den("USER_29","MiningPool_5");
        MutliThread_Cen_Den M30=new MutliThread_Cen_Den("USER_30","MiningPool_5");
        MutliThread_Cen_Den M31=new MutliThread_Cen_Den("USER_31","MiningPool_6");
        MutliThread_Cen_Den M32=new MutliThread_Cen_Den("USER_32","MiningPool_6");
        MutliThread_Cen_Den M33=new MutliThread_Cen_Den("USER_33","MiningPool_6");
        MutliThread_Cen_Den M34=new MutliThread_Cen_Den("USER_34","MiningPool_6");
        MutliThread_Cen_Den M35=new MutliThread_Cen_Den("USER_35","MiningPool_6");
        MutliThread_Cen_Den M36=new MutliThread_Cen_Den("USER_36","MiningPool_7");
        MutliThread_Cen_Den M37=new MutliThread_Cen_Den("USER_37","MiningPool_7");
        MutliThread_Cen_Den M38=new MutliThread_Cen_Den("USER_38","MiningPool_7");
        MutliThread_Cen_Den M39=new MutliThread_Cen_Den("USER_39","MiningPool_7");
        MutliThread_Cen_Den M40=new MutliThread_Cen_Den("USER_40","MiningPool_7");
        MutliThread_Cen_Den M41=new MutliThread_Cen_Den("USER_41","MiningPool_7");
        MutliThread_Cen_Den M42=new MutliThread_Cen_Den("USER_42","MiningPool_7");
        MutliThread_Cen_Den M43=new MutliThread_Cen_Den("USER_43","MiningPool_7");
        MutliThread_Cen_Den M44=new MutliThread_Cen_Den("USER_44","MiningPool_7");
        MutliThread_Cen_Den M45=new MutliThread_Cen_Den("USER_45","MiningPool_7");
